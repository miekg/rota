module chromium.googlesource.com/infra/rotang
...
require (
	...
	go.chromium.org/gae v0.0.0-20180903135824-2e2072ed4889
	go.chromium.org/luci v0.0.0-20190216021511-147bb2c6d6e4
